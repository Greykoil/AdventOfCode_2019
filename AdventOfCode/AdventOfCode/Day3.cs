            ...
            foreach (var instruction in firstInstructions)
            {
                ...
                switch (instruction[0])
                {
                    ...
                    case 'U':
                        for (int i = 1; i <= count; ++i)
                        {
                            pathOne.Add((lastPoint.Item1, lastPoint.Item2 + i));
                        }
                        break;
                    case 'D':
                        for (int i = 1; i <= count; ++i)
